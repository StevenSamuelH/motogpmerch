"""
Django settings for motogpmerch project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-^h!_alps7c16b7!k$o^^oe)vc3ud#_w3qs%enb1q1dw-u+#2$p')
...
WSGI_APPLICATION = 'motogpmerch.wsgi.application'
